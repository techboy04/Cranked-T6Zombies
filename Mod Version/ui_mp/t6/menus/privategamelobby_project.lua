...
CoD.PrivateGameLobby.ExfilOptions = {}
CoD.PrivateGameLobby.ExfilOptions[1] = {}
CoD.PrivateGameLobby.ExfilOptions[1].id = "enable_cranked"
CoD.PrivateGameLobby.ExfilOptions[1].name = "ENABLE CRANKED"
CoD.PrivateGameLobby.ExfilOptions[1].hintText = "Toggle the gamemode."
CoD.PrivateGameLobby.ExfilOptions[1].labels = {}
CoD.PrivateGameLobby.ExfilOptions[1].labels[1] = "ENABLED"
CoD.PrivateGameLobby.ExfilOptions[1].labels[2] = "DISABLED"
CoD.PrivateGameLobby.ExfilOptions[1].values = {}
CoD.PrivateGameLobby.ExfilOptions[1].values[1] = 1
CoD.PrivateGameLobby.ExfilOptions[1].values[2] = 0
CoD.PrivateGameLobby.ExfilOptions[1].maps = {}
CoD.PrivateGameLobby.ExfilOptions[1].maps[1] = "zm_transit"
CoD.PrivateGameLobby.ExfilOptions[1].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.ExfilOptions[1].maps[3] = "zm_buried"
CoD.PrivateGameLobby.ExfilOptions[1].maps[4] = "zm_prison"
CoD.PrivateGameLobby.ExfilOptions[1].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.ExfilOptions[1].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.ExfilOptions[1].gameTypes = {}
CoD.PrivateGameLobby.ExfilOptions[1].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.ExfilOptions[1].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.ExfilOptions = {}
CoD.PrivateGameLobby.ExfilOptions[2] = {}
CoD.PrivateGameLobby.ExfilOptions[2].id = "team_cranked_mode"
CoD.PrivateGameLobby.ExfilOptions[2].name = "TEAM CRANKED MODE"
CoD.PrivateGameLobby.ExfilOptions[2].hintText = "Toggle the Team Cranked mode, all players share the timer. Cranked must be enabled."
CoD.PrivateGameLobby.ExfilOptions[2].labels = {}
CoD.PrivateGameLobby.ExfilOptions[2].labels[1] = "ENABLED"
CoD.PrivateGameLobby.ExfilOptions[2].labels[2] = "DISABLED"
CoD.PrivateGameLobby.ExfilOptions[2].values = {}
CoD.PrivateGameLobby.ExfilOptions[2].values[1] = 1
CoD.PrivateGameLobby.ExfilOptions[2].values[2] = 0
CoD.PrivateGameLobby.ExfilOptions[2].maps = {}
CoD.PrivateGameLobby.ExfilOptions[2].maps[1] = "zm_transit"
CoD.PrivateGameLobby.ExfilOptions[2].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.ExfilOptions[2].maps[3] = "zm_buried"
CoD.PrivateGameLobby.ExfilOptions[2].maps[4] = "zm_prison"
CoD.PrivateGameLobby.ExfilOptions[2].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.ExfilOptions[2].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.ExfilOptions[2].gameTypes = {}
CoD.PrivateGameLobby.ExfilOptions[2].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.ExfilOptions[2].gameTypes[2] = "zstandard"
...
CoD.PrivateGameLobby.PopulateButtons_Project_Zombie = function (PrivateGameLobbyButtonPane, IsHost)
	if IsHost == true then
		...
		-- 	PrivateGameLobbyButtonPane.body.widestButtonTextWidth = f9_local1_3
		-- end
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.ExfilOptions, "dvar")
